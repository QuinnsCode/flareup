 ...
 *
 * WHAT THIS DOES:
 * 1. Extracts org slug from subdomain (ryan.APP_URL -> "ryan")
 ...
 * 1. Test login flow: APP_URL/user/login -> ryan.APP_URL/dashboard
 * 2. Test root redirect: ryan.APP_URL/ -> ryan.APP_URL/dashboard
