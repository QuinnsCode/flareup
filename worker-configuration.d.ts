/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: faa61009e4e952c2571bf745ffea2883)
// Runtime types generated with workerd@1.20251202.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SessionDurableObject" | "UserSessionDO" | "OrgScanDO";
	}
	interface Env {
		...
		ORG_SCAN_DO: DurableObjectNamespace<import("./src/worker").OrgScanDO>;
		DB: D1Database;
		ALERT_QUEUE: Queue;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_WEBHOOK_SECRET" | "TURNSTILE_SECRET_KEY" | "APP_URL" | "RESEND_FROM_EMAIL" | "APP_SECRET">> {}
}
